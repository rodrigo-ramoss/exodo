...
folder: Scriptorium
image: /image/sinais/o-exodo-antes-da-tempestade.webp
...
keywords: "#VozDoDeserto #Preparacao #Migracao #Exodo #PadroesHistoricos #ArquivoSecreto"
---
...
9. UNHCR. (2025). *Global Trends Report 2024*. Disponível em: unhcr.org
10. UNHCR Brasil. (2025). "Brasil bate recorde de solicitações de reconhecimento da condição de refugiado em 2024". Disponível em: acnur.org/br/node/4158
11. UNHCR Brasil. (2025). *Dados: refugiados no Brasil e no mundo*. Disponível em: acnur.org/br
12. Ministério da Justiça e Segurança Pública. (2025). *Refúgio em Números 2025*. Portal de Imigração.

### Sobre controles de capital e CBDCs

13. Zona Media. (2025, December 11). "Capital controls. Deputies introduce law stripping outspoken Russians in exile of access to banking".
14. Plisio. (2026, April 6). "Moedas digitais de banco central em 2026: 137 países, 3 lançamentos, 1 grande proibição".
15. DLA Piper. (2020). "Regulatory framework for CBDCs and GSCs: IMF's policy paper".

### Sobre regulação migratória no Brasil

16. Decreto nº 12.657, de 7 de outubro de 2025. *Institui a Política Nacional de Migrações, Refúgio e Apatridia*. Portal de Imigração.
17. ACNUR Brasil. (2026, February 24). "Oito anos da Operação Acolhida em oito perguntas".

### Sobre texto bíblico e análise lexical

18. Biblia Hebraica Stuttgartensia (5ª ed.). (1997). *Proverbia* (Provérbios 22:3). Deutsche Bibelgesellschaft.
19. Koehler, L., & Baumgartner, W. (2001). *The Hebrew and Aramaic Lexicon of the Old Testament* (HALOT). Brill. [Entradas para *arum* (עָרוּם), *ra'ah* (רָאָה), *nistar* (נִסְתָּר)].
20. Elliger, K., & Rudolph, W. (Eds.). (1997). *Biblia Hebraica Stuttgartensia*. Deutsche Bibelgesellschaft. [Êxodo 12:11]

### Sobre teoria de colapso e padrões históricos

21. Diamond, J. (2005). *Collapse: How Societies Choose to Fail or Succeed*. Viking Press.
22. Snyder, T. (2017). *On Tyranny: Twenty Lessons from the Twentieth Century*. Tim Duggan Books.

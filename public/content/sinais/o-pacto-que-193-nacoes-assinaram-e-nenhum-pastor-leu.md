---
title: "O Pacto que 193 Nações Assinaram e Nenhum Pastor Leu"
date: 2026-03-20
...
O texto grego usa *mían gnṓmēn* — literalmente, "uma opinião", "um julgamento unificado". Não é unanimidade forçada por coerção — é convergência voluntária de agentes soberanos em torno de um propósito compartilhado. O texto descreve reis que *entregam* — *didōsin*, presente do indicativo, ação em curso — seu poder e autoridade a uma estrutura supranacional.
...
**O Pacto para o Futuro é juridicamente vinculante para os países signatários?**

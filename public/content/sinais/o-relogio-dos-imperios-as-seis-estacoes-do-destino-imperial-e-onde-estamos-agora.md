...
**O que significa "recusar a idolatria do poder estabelecido" na prática?**
Significa não confundir preservação do sistema atual com fidelidade a valores transcendentes. Significa não tratar as instituições existentes — Estado, mercado, Igreja institucional — como fins em si mesmos que merecem lealdade incondicional. Significa manter a capacidade de reconhecer quando o sistema que deveria servir ao bem humano passou a servir à sua própria perpetuação — e ter coragem de nomear isso sem esperar permissão das instituições que seriam nomeadas.

...
faq:
  - question: "Is the mark of the Beast in Revelation a literal microchip or barcode?"
    answer: "No credible first-century scholar reads it that way. The mark (charagma) was a well-understood Roman administrative term for the imperial seal stamped on documents and coins required for commerce. John's audience in the seven churches of Asia Minor understood immediately: participation in the imperial economic cult, or economic exclusion. The 'mark' was never about skin — it was about system access. The microchip reading is a 20th-century American dispensationalist interpolation with no basis in the Greek text or its historical context."
  - question: "What is CBDC and why does it matter eschatologically?"
    answer: "Central Bank Digital Currency is programmable government-issued money that can be restricted by condition, geography, social behavior, or political status. Unlike cash, it is surveilled, revocable, and algorithmically gateable. Every purchase is recorded, every transaction is permissioned, every account can be frozen without judicial process. This is architecturally identical to what Revelation 13:17 describes: no one can buy or sell without the mark. The eschatological question is not whether this technology exists — it does — but whether the Church has anything to say about it before the system is fully operational."
  - question: "Does this mean every government ID system is the mark of the Beast?"
    answer: "No — and that distinction matters enormously. The biblical text describes a system of economic exclusion tied to worship of a specific power structure. A CPF, Aadhaar, or Social Security number is not the mark. What the text warns against is a system in which identity verification becomes the condition for economic participation, and that participation requires an act of allegiance — explicit or implicit — to a power that claims total sovereignty over human life. The question is not the technology. It is the allegiance the technology enforces."
---

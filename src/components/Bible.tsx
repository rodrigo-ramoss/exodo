...
const AXIS_METADATA: AxisMeta[] = [
  {
    ...
    coverImage: '/assets/imagens/eixos-biblicos/capa-eixo-1-geografia-invisivel.webp',
  ...
  },
  {
    ...
    coverImage: '/assets/imagens/eixos-biblicos/capa-eixo-3-rebeliao-cosmica.webp',
  ...
  },
  {
    ...
    coverImage: '/assets/imagens/eixos-biblicos/capa-eixo-4-tecnologia-alianca.webp',
  ...
  },
  {
    ...
    coverImage: '/assets/imagens/eixos-biblicos/capa-eixo-5-linhagem-semente.webp',

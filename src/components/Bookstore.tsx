...
function pickCategoryByFolder(folder: string): string {
  ...
  const dynamicMap: Array<[string, string]> = [
    ...
    ['serie - o trono abalado', 'Série — O Trono Abalado'],
...
const SERIES_DESCRIPTION: Record<string, string> = {
  ...
  'Série — O Trono Abalado': 'Uma investigação sobre a origem do adversário, a queda do querubim e a restauração do trono em Cristo.',

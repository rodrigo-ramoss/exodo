...
const CATEGORY_TO_SECTION: Record<string, SectionKey> = {
  ...
  'Série — O Manual do Exorcista':            'JESUS CRISTO',
...
const SERIES_LABEL: Record<string, string> = {
  ...
  'Série — O Manual do Exorcista':            'O Manual do Exorcista',
...
const SERIES_DESCRIPTION: Record<string, string> = {
  ...
  'Série — O Manual do Exorcista': 'Uma série prática e bíblica sobre libertação em Cristo: autoridade no Nome de Jesus, discernimento espiritual, santidade e cuidado pastoral.',

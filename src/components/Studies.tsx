...
const FALLBACK_TEMAS: ManaTema[] = [
  ...
  {
    id: 'andar-como-jesus-andou',
    slug: 'vida-exterior/andar-como-jesus-andou',
    badge: 'E-BOOK 01',
    title: 'Andar como Jesus Andou - A Caminhada do Discípulo à Luz de 1 João',
    status: 'published',
    image: '/image/mana/andar como jesus andou.webp',
    file: 'tenda 3 vida exterior/Andar como Jesus Andou.md',
  },
  {
    id: 'como-ganhar-seu-marido-pra-jesus',
    slug: 'vida-exterior/como-ganhar-seu-marido-pra-jesus',
    badge: 'E-BOOK 02',
    title: 'Como Ganhar Seu Marido pra Jesus - O Testemunho Silencioso que Transforma o Lar',
    status: 'published',
    image: '/image/mana/como ganhar seu marido pra jesus.webp',
    file: 'tenda 3 vida exterior/Como Ganhar Seu Marido pra Jesus — O Testemunho Silencioso que Transforma o Lar.md',
  },
  {
    id: 'qual-a-versao-de-deus-que-as-pessoas-veem-em-voce',
    slug: 'vida-exterior/qual-a-versao-de-deus-que-as-pessoas-veem-em-voce',
    badge: 'E-BOOK 03',
    title: 'Qual a Versão de Deus que as Pessoas Veem em Você? - O Evangelho que Pregamos sem Palavras',
    status: 'published',
    image: '/image/mana/qual a versao de deus que as pessoas veem em vvc.webp',
    file: 'tenda 3 vida exterior/Qual a Versão de Deus que as Pessoas Veem em Você.md',
  },
  {
